...
int main( int argc, char **argv) {
    ...
    // }
    if(inputSize == 8){
        uniquecounter = eightAnalyzeInput(inputBuforLength, inputBufor, in, charcounter, uniquecounter);
    }
    else if(inputSize == 16){
        // 16
        // while( inputBuforLength = fread( inputBufor, 1, 1200, in ) ) {
    ...
    if(inputSize == 8){
        ...
        //     fwrite(character, 1, 1, out);
        // }
        eightOutputGenerator(c, in, bufor, buforLength, character, characterBinary, size, codes, out);
    }
    else if(inputSize == 16){
        ...
        //     fwrite(character, 1, 1, out);
        // }
        sixteenOutputGenerator(inputBuforLength, inputBufor, in, input, bufor, buforLength, character, characterBinary, size, codes, out);
    }
    else if(inputSize == 12){
        ...
        //     fwrite(character, 1, 1, out);
        // }
        twelveOutputGenerator(inputBuforLength, inputBufor, in, input, bufor, buforLength, character, characterBinary, size, codes, out);
    }
